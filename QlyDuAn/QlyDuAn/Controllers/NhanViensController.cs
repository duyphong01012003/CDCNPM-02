	...
	public class NhanViensController : ControllerBase
	{
		...
		public async Task<IActionResult> DeleteNhanVien(int id)
		{
			...
			try
			{
				...
				var tank = await _context.Tasks.Where(t => t.IdnhanVienNhanTask == id).ToListAsync();
				if (tank.Any())
				{
				...
				var taskCon = await _context.TaskCons.Where(tc => tc.IdnguoiTaoTask == id).ToListAsync();
				if (taskCon.Any())
				{
