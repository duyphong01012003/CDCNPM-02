...
namespace QlyDuAn.Services
{
	public class RegisterService
	{
		...
		public async Task<TaiKhoan> Register(RegisterRequest registerRequest)
		{
			...
			try
			{
				...
				if (registerRequest.QuyenTaiKhoan == "NhanVien")
				{
					var nhanvien = new NhanVien
					{
						...
						IdnguoiQuanLy = registerRequest.IdnguoiQuanLy,
						IdnhomLamViec = registerRequest.IdnhomLamViec
					};
